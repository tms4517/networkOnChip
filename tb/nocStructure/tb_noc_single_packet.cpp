...
void drivePacket(Vnoc *dut, int src_row, int src_col, int dst_row, int dst_col,
  ...
  // LSB layout: [1:0]=dstCol, [3:2]=dstRow, [5:4]=srcCol, [7:6]=srcRow, [76:8]=payload
...
uint64_t extractPayloadFromRouter(Vnoc *dut, int row, int col) {
  ...
  // Read 77 bits across 3 words, then extract payload from bits [76:8]
  ...
  // Payload is at bits [76:8] — shift packet_low right by 8 and combine
