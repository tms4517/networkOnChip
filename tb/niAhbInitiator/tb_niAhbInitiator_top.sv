// Testbench wrapper
// This module instantiates the NOC and connects a single Ahb Initiator
// to a router (SRC_ROW, SRC_COL). AHB and destination monitor ports are
// exposed to C++ via Verilator. A C++ AHB driver can drive AHB transactions
// into the initiator and observe the responses.

`default_nettype none

module tb_niAhbInitiator_top
...
, input  var logic i_arst_n
  ...
  // AHB-Lite subordinate interface — driven by C++
...
, output var logic [NUM_ROUTERS*PACKET_WIDTH-1:0]      o_routerToNi_flat
  ...
  // niAhbInitiator instance — connected at (SRC_ROW, SRC_COL)
  ...
  // HREADY of the single-slave AHB system is the NI's own HREADYOUT.
  logic                    ahb_hreadyout;
  // }}} Interconnects
